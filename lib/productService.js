// lib/productService.js - ISR Optimized with Stock Management
  ...
  try {
    ...
    const transformedProducts = data.map(product => {
      return {
        ...
        // ✅ إضافة حالة المخزون
        in_stock: product.in_stock !== false, // افتراضياً متاح
  ...
  if (buildMode) {
    ...
    try {
      ...
      const transformedProduct = {
        ...
        in_stock: data.in_stock !== false, // ✅ إضافة حالة المخزون
        isr_fetched_at: new Date().toISOString()
      }
